...
class CalculateMealNutrients @Inject constructor(
    ...
    operator fun invoke(trackedFoods: List<TrackedFood>): Result {
        ...
        val carbsGoal =
            (caloryGoal * userInfo.carbRatio / 4f).roundToInt() // 1 gram of carb has 4 calories
        val proteinGoal =
            (caloryGoal * userInfo.proteinRatio / 4f).roundToInt() // 1 gram of protein has 4 calories
        val fatGoal =
            (caloryGoal * userInfo.fatRatio / 9f).roundToInt() // 1 gram of fat has 9 calories
    ...
    /**
     * Calculate how many calories a user burns on a specific day if they don't do exercise
     */
